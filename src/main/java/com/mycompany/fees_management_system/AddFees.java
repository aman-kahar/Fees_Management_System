...
public class AddFees extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("D:\\MAJOR PROJECT DATABASE\\Icon_Images\\my icons\\add_fees_logo.png")); // NOI18N
        ...
        panelParent.add(panelChild, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, -1, 592));
    ...
    private void btn_PrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_PrintActionPerformed
        if (validation() == true) {
            ...
            if (status.equals("Success")) {
                JOptionPane.showMessageDialog(this, "Fees Record Inserted");
